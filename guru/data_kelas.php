...
<head>
    ...
    <title>Data Kelas - SMK INDONESIA RAYA</title>
    ...
    <div class="row">
        <div class="col-md-2 sidebar p-0 d-flex flex-column justify-content-between">
            <div>
                ...
                <nav class="nav flex-column mt-3">
                    ...
                    <a class="nav-link active" href="data_kelas.php"><i class="bi bi-door-closed me-2"></i> Lihat Data Kelas</a>
                </nav>
            </div>
        ...
        <div class="col-md-10 bg-light min-vh-100 p-4">
            <div class="d-flex justify-content-between align-items-center bg-white p-3 rounded shadow-sm mb-4">
                <h5 class="fw-bold mb-0 text-secondary">Data Kelas</h5>
                <div class="fw-semibold">Log In: <span class="text-success"><?= $user_login; ?></span></div>
            </div>

            <div class="card border-0 shadow-sm p-4 bg-white rounded-3">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold mb-0"><i class="bi bi-door-open text-success me-2"></i>Daftar Kelas Monitoring</h5>
                </div>
                <table class="table table-hover table-bordered text-center align-middle">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><span class="badge bg-info text-dark">Monitoring Aktif</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
